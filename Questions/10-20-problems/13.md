...
class AutonomousCar {
    ...
    public AutonomousCar(int carId, String brand, int noOfTestsConducted,
                         int noOfTestsPassed, String environment) {
        this.carId = carId;
        this.brand = brand;
...
public class Solution {
    ...
    public static int findTestPassedByEnv(AutonomousCar[] cars,
                                          String environment) {
    ...
    public static AutonomousCar updateCarGrade(AutonomousCar[] cars,
                                               String brand) {
        ...
        for (AutonomousCar car : cars) {
            ...
            if (car.getBrand().equalsIgnoreCase(brand)) {
                ...
                double rating =
                        (car.getNoOfTestsPassed() * 100.0)
                        / car.getNoOfTestsConducted();
    ...
    public static void main(String[] args) {
        ...
        int totalTestsPassed =
                findTestPassedByEnv(cars, environment);
        ...
        AutonomousCar result =
                updateCarGrade(cars, brand);

        if (result != null) {
            System.out.println(
                result.getBrand() + "::" + result.getGrade());
        } else {
            System.out.println(
                "No Car is available with the specified brand");
        }
    }
}
