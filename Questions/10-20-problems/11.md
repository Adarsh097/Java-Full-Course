...
public class Solution {
    ...
    public static int findPointsForGivenSkill(ArrayList<Player> players,
                                              String skill) {
        int sum = 0;
    ...
    public static Player getPlayerBasedOnLevel(ArrayList<Player> players,
                                               String level,
                                               String skill) {

        for (Player p : players) {
            if (p.getLevel().equalsIgnoreCase(level)
                    && p.getSkill().equalsIgnoreCase(skill)
                    && p.getPoints() >= 20) {
                return p;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            players.add(new Player(playerId, skill, level, points));
        }
        ...
        Player result = getPlayerBasedOnLevel(players, level, skill);
