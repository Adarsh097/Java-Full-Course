...
public class Solution {
    ...
    public static Institution updateInstitutionGrade(Institution[] instArray, String instName) {
        ...
        for (Institution i : instArray) {
            ...
            if (i.getInstitutionName().equalsIgnoreCase(instName)) {

                int rating = (i.getNoOfStudentsPlaced() * 100)
                        / i.getNoOfStudentsCleared();
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            arr[i] = new Institution(id, name, placed, cleared, location);
        }

        String searchLocation = sc.nextLine();
        String searchInstitution = sc.nextLine();

        int result = findNumClearancedByLoc(arr, searchLocation);
        ...
        Institution ans = updateInstitutionGrade(arr, searchInstitution);
