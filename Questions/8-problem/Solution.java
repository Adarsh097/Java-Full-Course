...
public class Solution {
    ...
    public static int noOfRoomsBookedInGivenMonth(ArrayList<Hotel> hotels,
                                                  String month) {
        int totalRooms = 0;
    ...
    public static Hotel searchHotelByWifiOption(ArrayList<Hotel> hotels,
                                                String wifiOption) {

        ArrayList<Hotel> matchedHotels = new ArrayList<>();
        ...
        matchedHotels.sort((h1, h2) ->
                Double.compare(h2.getTotalBill(), h1.getTotalBill()));

        return matchedHotels.get(1); // second highest bill
    }
